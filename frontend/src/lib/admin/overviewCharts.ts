...
export function buildLineChartPoints(values: number[], options: { width: number; height: number; maxValue: number }) {
...
export function buildAnalyticsTotals(input: { fileInventory: InventoryCounts[]; deliveryTrend: DeliveryTrendBucket[] }) {
  return {
