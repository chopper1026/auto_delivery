...
type SelectProps = Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, "children" | "name" | "onChange" | "value" | "defaultValue"> & {
...
function optionText(children: React.ReactNode): string {
  ...
  return React.Children.toArray(children).map(optionText).join("");
}
